"""Fisrt Postgres Commit

Revision ID: 3ab32883918e
Revises: 
Create Date: 2020-06-06 22:33:49.134673
...
def upgrade():
    ...
    sa.Column('telefono', sa.String(length=18), nullable=True),
    sa.Column('email', sa.String(length=120), nullable=True),
